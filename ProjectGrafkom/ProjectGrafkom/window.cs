...
namespace ProjectGrafkom
{
    ...
    internal class window : GameWindow
    {
        ...
        protected override void OnLoad()
        {
            ...
            //Untuk background
            GL.ClearColor(0.8f, 0.9f, 1.0f, 0);
            {
            }
            {
                //Enviroment tanah
                temp = new Mesh();
                temp.createEllips(0.15f, 0.65f, 0.0f, 20f, 0.1f, 10f);
                ...
                //bawah
                temp = new Mesh();
                temp.createBalok(12.5f, 0.5f, 3.0f, 2.0f);
                temp.setupObject(shader_vert, shader_frag);
                temp.setColor(0.9f, 0.9f, 0.8f);
                Rumah.Add(temp);
                //bawah2
                temp = new Mesh();
                temp.createBalok(14.0f, 0.5f, 3.0f, 2.0f);
                temp.setupObject(shader_vert, shader_frag);
                temp.setColor(0.9f, 0.9f, 0.8f);
                Rumah.Add(temp);
                //bawahblakang
                temp = new Mesh();
                temp.createBalok(12.5f, 0.5f, 1.68f, 2.0f);
                temp.setupObject(shader_vert, shader_frag);
                temp.setColor(0.9f, 0.9f, 0.8f);
                Rumah.Add(temp);
                //bawahblakang 2
                temp = new Mesh();
                temp.createBalok(14.0f, 0.5f, 1.68f, 2.0f);
                temp.setupObject(shader_vert, shader_frag);
                temp.setColor(0.9f, 0.9f, 0.8f);
                Rumah.Add(temp);
                //atap
                temp = new Mesh();
                //kanan kiri, depan blakang, atas bawah
                temp.createCone(13.0f, -2.65f, 3.6f, 1.8f, 1.8f, 1.35f);
                temp.setupObject(shader_vert, shader_frag);
                temp.setColor(0.7f, 0.5f, 0.2f);
                temp.rotate(-90f, 0f, 0f);
                Rumah.Add(temp);
                //pintu
                temp = new Mesh();
                temp.createBalok(13.2f, 0.2f, 3.1f, 2.0f);
                temp.setupObject(shader_vert, shader_frag);
                temp.setColor(0.9f, 0.7f, 0.4f);
                Rumah.Add(temp);
                ...
                temp = new Mesh();
                //kanan kiri, depan blakang, atas bawah
                temp.createCone(-13.5f, -2.65f, 3.6f, 1.8f, 1.8f, 1.35f);
                temp.setupObject(shader_vert, shader_frag);
                temp.setColor(0.7f, 0.5f, 0.2f);
                temp.rotate(-90f, 0f, 0f);
                Rumah.Add(temp);
        ...
        protected override void OnRenderFrame(FrameEventArgs args)
        {
            ...
            _camera.Position = Vector3.Add(Vector3.TransformPosition(asset[1]._centerPosition, asset[1]._model), new Vector3(0.0f, 0.0f, 6f));
            ...
            for (int i = 0; i < Rumah.Count; i++)
            {
                Rumah[i].render(_camera);
            }
            for (int i = 0; i < asset_curve.Count; i++)
            {
